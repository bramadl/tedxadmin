    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Table Cores
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab">
                                <table class="table table-responsive-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $core['first_name'] }} {{ $core['last_name'] }}</td>
                                            <td>{{ $core['email_address'] }}</td>
                                            <td>{{ $core['phone_number'] ? $core['phone_number'] : '-' }}</td>
                                            <td>{{ $core['street_address'] ? $core['street_address'] : '-' }}</td>
                                            <td>{{ $core['role'] }}</td>
                                            <td>{{ $core['division'] }}</td>
                                            <td>{{ $core['verified'] ? 'Confirmed' : 'Not Confirmed' }}</td>
                                            <td>{{ date('d M, Y', strtotime($core['created_at'])) }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                            ...
                            <div class="tab-pane fade" id="pills-event" role="tabpanel" aria-labelledby="pills-event-tab">
                                <table class="table table-responsive-sm">
                                    ...
                                    <tbody>
                                        @foreach ($cores as $key => $core)
                                        @if ($core['division'] === 'Event Manager')
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $core['first_name'] }} {{ $core['last_name'] }}</td>
                                            <td>{{ $core['email_address'] }}</td>
                            ...
                            <div class="tab-pane fade" id="pills-executive" role="tabpanel" aria-labelledby="pills-executive-tab">
                                <table class="table table-responsive-sm">
                                    ...
                                    <tbody>
                                        @foreach ($cores as $key => $core)
                                        @if ($core['division'] === 'Executive Producer')
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $core['first_name'] }} {{ $core['last_name'] }}</td>
                                            <td>{{ $core['email_address'] }}</td>
                            ...
                            <div class="tab-pane fade" id="pills-video" role="tabpanel" aria-labelledby="pills-video-tab">
                                <table class="table table-responsive-sm">
                                    ...
                                    <tbody>
                                        @foreach ($cores as $key => $core)
                                        @if ($core['division'] === 'Video Production')
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $core['first_name'] }} {{ $core['last_name'] }}</td>
                                            <td>{{ $core['email_address'] }}</td>
